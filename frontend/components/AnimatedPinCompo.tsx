...
//             <PinContainer title={item.linkName} href={item.link}>
//               <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[25vh] mb-5">
//                 <div className="relative w-full h-full overflow-hidden lg:rounded-3xl bg-secondary">
//                   <img
//                     src={item.img}
//                     alt="cover"
//                     className="z-0 absolute w-full object-contain"
...
//               <p
//                 className="font-mono lg:text-xl lg:font-light font-light text-sm text-secondary line-clamp-2"
//               >
//                 {item.des}
//               </p>
...
//                 <div className="flex justify-center items-center">
//                   <p className="flex lg:text-xl md:text-xs text-sm text-accent-purple font-mono">
//                     Check Live Site
//                   </p>
