...
//   const rightLists = ["MongoDB", "NodeJS", "Tawilwind CSS"];
...
//           )}
//         >
//           <div className="font-sans font-extralight md:max-w-32 md:text-xs lg:max-w-40 lg:text-sm text-secondary z-10">
//             {description}
//           </div>
//           <div
//             className="font-sans text-lg lg:text-3xl max-w-96 font-bold text-primary z-10"
//           >
//             {title}
//           </div>
...
//                   <span
//                     key={i}
//                     className="py-2 px-3 md:py-4 md:px-3 text-xs md:text-base rounded-lg text-center bg-accent-blue/20 text-accent-blue hover:bg-accent-blue/40 transition"
//                   >
//                     {item}
//                   </span>
//                 ))}
...
//                   <span
//                     key={i}
//                     className="py-2 px-3 md:py-4 md:px-3 text-xs md:text-base rounded-lg text-center bg-accent-purple/20 text-accent-purple hover:bg-accent-purple/40 transition"
//                   >
//                     {item}
//                   </span>
//                 ))}
